                            ...
                            <form action="{{ route('storeebook') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="nama" placeholder="Masukan Nama Buku">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <textarea name="Deskripsi" id="description" class="form-control" rows="4" placeholder="Masukan deskripsi"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="qty" class="form-label">Stok</label>
                                        <input type="text" class="form-control" id="qty" name="stok" placeholder="Masukan Stok">
                                    </div>
                                </div>
