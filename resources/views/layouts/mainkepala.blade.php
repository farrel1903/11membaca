...
<head>
    ...
    <link href="{{ asset('assets/sbadminkepala/css/admin.css') }}" rel="stylesheet" />
...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="/kepala/rekaponline">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-book"></i></div>
                            Rekap Peminjaman Online
                        </a>
    ...
    <script src="{{ asset('assets/sbadminkepala/js/admin.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
    <script src="{{ asset('assets/sbadminkepala/assets/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('assets/sbadminkepala/assets/demo/chart-bar-demo.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
    <script src="{{ asset('assets/sbadminkepala/js/datatables-simple-demo.js') }}"></script>
</body>
